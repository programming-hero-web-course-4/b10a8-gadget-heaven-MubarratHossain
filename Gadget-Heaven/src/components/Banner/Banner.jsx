...
const Banner = () => {
    return (
        <div className="relative text-center mt-12">
            ...
            <button className="mt-6 mb-4 px-6 py-2 bg-white text-[#9538E2] rounded-full font-semibold shadow-md 
            ...
            <img
                ...
                className="absolute left-1/2 transform -translate-x-1/2 -translate-y-10 w-[50%] mt-12 rounded-2xl border-4 border-white ring-2 ring-[#9538E2] transition-all duration-300 ease-in-out hover:ring-4"
            />
        </div>
